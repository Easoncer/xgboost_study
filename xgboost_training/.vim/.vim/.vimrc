...
command! -nargs=0 Translation exec("py3 translation()")
map <C-t> <Esc>:Translation <cr>
imap <C-t> <Esc>:Translation <cr>
...
" \'java' : 1,
"跳转定义和声明
" 用这个替换自带的gd太好使了，ctags完全可以抛弃了，cscope可能还有点用
nnoremap gd :YcmCompleter GoToDefinitionElseDeclaration<CR>

" 打开location-list来显示警告和错误的信息:YcmDiags
let g:ycm_error_symbol = '>>'
let g:ycm_warning_symbol = '>*'
nmap <Leader>oe :YcmDiags<CR>
" " 设置在下面几种格式的文件上不开启ycm补全
